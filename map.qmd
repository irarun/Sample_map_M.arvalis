...
# "Microsat", "Cytochrom b", "GewebeRack", "Number in Fridge oder -20C oder -80C", "DNADNA_.Number.in..20", "RNARNA_.Number.in..80",	"Lung.Tissue", "Positive? (TULV)", "Published")
Data <- rawTable[, cols]
#View(Data)
...
map <- map %>%
  ...
  addLegend(
    ...
    labels = "Frosen specimen at -20",  # labels = c("DNA extracted", "RNA extracted", "DNA & RNA extracted"),
